...
TEST_F(CredentialsTest, TlsCredentialReloadConfigCppToC) {
  ...
  EXPECT_STREQ(c_arg.error_details->err_details().c_str(),
...
TEST_F(CredentialsTest, TlsCredentialsOptionsCppToC) {
  ...
  c_credential_reload_arg.error_details->set_err_details(
      test_error_details.c_str());
  ...
  c_server_authorization_check_arg.error_details->set_err_details(
      "error_details");
  ...
  EXPECT_STREQ(
      c_server_authorization_check_arg.error_details->err_details().c_str(),
      "sync_error_details");
